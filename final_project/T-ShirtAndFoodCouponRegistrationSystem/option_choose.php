...
<body>
    ...
    <br><br>
    <?php echo "<p><h1><u><center>".$_GET['fest_name'].' '."Registration</u></center></h1></p> "; ?>
    <br><br><br>
    <form name="option_choose" action="register.php" method="post"> 
      <fieldset class="option_area">
        <legend>Your Option</legend>
        <input type="checkbox" name="tshirt" id="t" value="tshirt" onblur="enable();">T-Shirt <br><br>
        <input type="checkbox" name="food" value="yes">Food Coupon <br><br>
        
        T-Shirt Size:
        <select name="tsize" id="tshirt" style="width: 200px;height: 30px;text-align: center; font-weight: bold;border: 3px blue double;visibility:hidden;">
