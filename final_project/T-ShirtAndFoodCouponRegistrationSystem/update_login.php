...
<html>
   ...
   <body>
       ...
       <form name="loginupdate" action="update_logincheck.php" method="post">  
         <fieldset class="login_area">
            <legend>STUDENT UPDATE</legend>
            <br>
            <table border="0" cellspacing="3" cellpadding="6">
               <tr>
                   <th><font size="4"><label>Roll No:</label></font></th><th><input type="text" name="roll_no"></th><br><br>
               </tr>
           
               <tr>
                   <th><font size="4"><label>Password:</label></font></th><th><input type="password" name="pass"></th>  
               </tr>
             </table>               
              <br>
              <b><input title="Login" type="submit" name="sub" value="Login" /></b>       
